...
"[project]/src/features/landing/components/jobs/jobs-section.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getJobCategoryIcon(category) {
    var _category_trim_toLowerCase;
    const normalized = (_category_trim_toLowerCase = category === null || category === void 0 ? void 0 : category.trim().toLowerCase()) !== null && _category_trim_toLowerCase !== void 0 ? _category_trim_toLowerCase : "";
    if (/(engineer|engineering|tech|software|product)/.test(normalized)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$code$2d$xml$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Code2$3e$__["Code2"];
    }
    ...
    if (/(sales|growth|business|revenue|go.?to.?market)/.test(normalized)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chart$2d$line$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__LineChart$3e$__["LineChart"];
    }
...
function JobsSection(param) {
    let { compact = false, initialOpenings = EMPTY_OPENINGS } = param;
    _s();
    const { i18n, t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"])();
    const language = i18n.language.startsWith("fr") ? "fr" : "en";
    const labels = copy[language];
    const [workspaceOpenings, setWorkspaceOpenings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialOpenings);
    const [query, setQuery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [team, setTeam] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("all");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JobsSection.useEffect": ()=>{
            let cancelled = false;
            void (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$landing$2f$data$2f$workspace$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWorkspacePublicContent"])().then({
                "JobsSection.useEffect": (content)=>{
                    if (!cancelled) {
                        var _content_jobs_map;
                        const jobs = (_content_jobs_map = content === null || content === void 0 ? void 0 : content.jobs.map(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$landing$2f$data$2f$workspace$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["workspaceJobToOpening"])) !== null && _content_jobs_map !== void 0 ? _content_jobs_map : [];
    ...
    const teams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "JobsSection.useMemo[teams]": ()=>{
            return Array.from(new Set(workspaceOpenings.map({
                "JobsSection.useMemo[teams]": (job)=>job.team
            }["JobsSection.useMemo[teams]"]).filter(Boolean))).sort({
                "JobsSection.useMemo[teams]": (a, b)=>a.localeCompare(b)
            }["JobsSection.useMemo[teams]"]);
        }
    }["JobsSection.useMemo[teams]"], [
        workspaceOpenings
    ]);
    const filteredOpenings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "JobsSection.useMemo[filteredOpenings]": ()=>{
            const normalizedQuery = query.trim().toLowerCase();
            return workspaceOpenings.filter({
                "JobsSection.useMemo[filteredOpenings]": (job)=>{
                    const content = job[language];
                    const matchesTeam = team === "all" || slugify(job.team) === team;
                    const matchesStatus = job.status === "open";
                    const matchesQuery = !normalizedQuery || "".concat(content.title, " ").concat(content.description, " ").concat(job.team, " ").concat(job.location, " ").concat(job.type, " ").concat(job.workMode).toLowerCase().includes(normalizedQuery);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            !compact && workspaceOpenings.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    teams.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            teams.map((item)=>{
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    className: "inline-flex h-9 items-center gap-1.5 border px-3 text-sm font-semibold transition-colors ".concat(team === value ? "border-orange-200 bg-white text-orange-700 shadow-sm dark:bg-neutral-950 dark:text-orange-400" : "border-neutral-200 bg-white text-neutral-600 hover:border-orange-200 hover:text-orange-600 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-300"),
            ...
            openings.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    showWorkMode ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "bg-neutral-100 px-2.5 py-1 text-neutral-700 dark:bg-neutral-900 dark:text-neutral-300",
                                    ...
                                    isTaken ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            isTaken && job.occupantName ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                href: "mailto:".concat(CONTACT_EMAIL, "?subject=Prosperify%20job%20application"),
                                children: [
                                    t("jobs.apply"),
...
_s(JobsSection, "DgmwvZOtA5z4rKjs4eXrkNHRTE8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"]
    ];
});
_c = JobsSection;
var _c;
__turbopack_context__.k.register(_c, "JobsSection");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/features/landing/components/jobs/jobs-page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$landing$2f$components$2f$footer$2f$footer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/landing/components/footer/footer.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$landing$2f$components$2f$jobs$2f$jobs$2d$section$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/landing/components/jobs/jobs-section.tsx [app-client] (ecmascript)");
...
;
;
function JobsPage(param) {
    let { initialOpenings, lang } = param;
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JobsPage.useEffect": ()=>{
            if (lang === "fr" || lang === "en") {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$landing$2f$components$2f$jobs$2f$jobs$2d$section$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JobsSection"], {
...
_s(JobsPage, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = JobsPage;
var _c;
...
//# sourceMappingURL=src_b792e817._.js.map